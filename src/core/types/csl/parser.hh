...
/**
 ** \file parser.hh
 ** Define the co::csl::parser class.
 */

// C++ LALR(1) parser skeleton written by Akim Demaille.

#ifndef YY_CSL_PARSER_HH_INCLUDED
# define YY_CSL_PARSER_HH_INCLUDED
...
namespace co { namespace csl {
  ...
  public:
    ...
    Parser (co::csl::Loader& loader_yyarg, void* scanner_yyarg);
    virtual ~Parser ();
...
#endif // !YY_CSL_PARSER_HH_INCLUDED
