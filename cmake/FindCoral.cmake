...
# Require support for C++11 (Clang 3.3+, GCC 4.8+, MSVC 2013+)
if( MSVC )
  if( MSVC_VERSION LESS 1800 )
    message( FATAL_ERROR "Coral requires Visual Studio 2013 or newer." )
  endif()
else()
...
foreach( config IN LISTS CMAKE_CONFIGURATION_TYPES ITEMS ${CMAKE_BUILD_TYPE} )
  ...
  list( APPEND CORAL_CONFIG_SUFFIXES "_${upper}" )
endforeach()
...
macro( CORAL_TARGET_PROPERTIES targetName )
  ...
  # Define 'NDEBUG' for all configs except Debug
  set_property( TARGET ${targetName} APPEND PROPERTY COMPILE_DEFINITIONS $<$<NOT:$<CONFIG:Debug>>:NDEBUG> )
