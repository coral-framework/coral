...
{
	co::RefPtr<co::ITypeBuilder> builder = TestHelper::createBuilder( co::TK_INTERFACE, name );
...
TEST( SignatureCalculatorTests, binarySignatureIndependsOnFieldDefineOrder )
{
	...
	co::RefPtr<co::ITypeBuilder> builder = TestHelper::createBuilder( co::TK_INTERFACE, "createBinarySignatureTests.First" );
	...
	co::RefPtr<co::ITypeBuilder> builder2 = TestHelper::createBuilder( co::TK_INTERFACE, "createBinarySignatureTests.Second" );
...
TEST( SignatureCalculatorTests, arraySignatures )
{
	...
	co::IType* interfaceTest = createDummyInterface( "ArraySignaturesTest.IService" );
	co::IType* interfaceCopy = createDummyInterface( "ArraySignaturesTest.InterfaceCopy" );
...
{
	co::RefPtr<co::ITypeBuilder> builder = TestHelper::createBuilder( co::TK_ENUM, "EnumSignatureTest.First" );
	...
	co::RefPtr<co::ITypeBuilder> builder2 = TestHelper::createBuilder( co::TK_ENUM, "EnumSignatureTest.FirstCopy" );
	...
	co::RefPtr<co::ITypeBuilder> builder3 = TestHelper::createBuilder( co::TK_ENUM, "EnumSignatureTest.FirstSwitch" );
	...
	co::RefPtr<co::ITypeBuilder> builder4 = TestHelper::createBuilder( co::TK_ENUM, "EnumSignatureTest.FirstShift" );
...
{
	co::RefPtr<co::ITypeBuilder> builder1 = TestHelper::createBuilder( co::TK_INTERFACE, "MethodSignatureTest.First" );
	...
	co::RefPtr<co::ITypeBuilder> var1builder = TestHelper::createBuilder( co::TK_INTERFACE, "MethodSignatureTest.Variation1" );
	...
	co::RefPtr<co::ITypeBuilder> var2builder = TestHelper::createBuilder( co::TK_INTERFACE, "MethodSignatureTest.Variation2" );
	...
	co::RefPtr<co::ITypeBuilder> var3builder = TestHelper::createBuilder( co::TK_INTERFACE, "MethodSignatureTest.Variation3" );
	...
	co::RefPtr<co::ITypeBuilder> var4builder = TestHelper::createBuilder( co::TK_INTERFACE, "MethodSignatureTest.Variation4" );
	...
	co::RefPtr<co::ITypeBuilder> var5builder = TestHelper::createBuilder( co::TK_INTERFACE, "MethodSignatureTest.Variation5" );
...
{
	co::RefPtr<co::ITypeBuilder> builder1 = TestHelper::createBuilder( co::TK_INTERFACE, "FieldSignatureTest.First" );
	builder1->defineField( "name", TestHelper::type( "string" ), true );
	co::IInterface* first = co::cast<co::IInterface>( builder1->createType() );

	//variations with the same binary signature
	co::RefPtr<co::ITypeBuilder> builder2 = TestHelper::createBuilder( co::TK_INTERFACE, "FieldSignatureTest.SameBinary1" );
	builder2->defineField( "name", TestHelper::type( "string" ), true );
	co::IInterface* sameBinary1 = co::cast<co::IInterface>( builder2->createType() );

	co::RefPtr<co::ITypeBuilder> builder3 = TestHelper::createBuilder( co::TK_INTERFACE, "FieldSignatureTest.SameBinary2" );
	...
	// variations with diferent signature
	co::RefPtr<co::ITypeBuilder> builder4 = TestHelper::createBuilder( co::TK_INTERFACE, "FieldSignatureTest.Variation1" );
	...
	co::RefPtr<co::ITypeBuilder> builder5 = TestHelper::createBuilder( co::TK_INTERFACE, "FieldSignatureTest.Variation2" );
